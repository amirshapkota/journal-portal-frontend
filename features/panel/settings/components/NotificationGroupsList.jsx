...
export const notificationGroups = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Be informed when your personal details or contact information change.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Get updates when data between your account and ORCID is synchronized.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Be alerted when someone comments or gives feedback on your project.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description:
          "Get an email when someone invites you to collaborate on a project.",
      },
      {
        id: "email_on_invite_accepted",
        label: "Invite Accepted",
        description:
          "Receive confirmation when a collaborator accepts your invitation.",
      },
      {
        id: "email_on_invite_declined",
        label: "Invite Declined",
        description:
          "Be notified if a collaborator declines your project invitation.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Be alerted when reviews or editorial feedback are submitted for your work.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description:
          "Stay informed about upcoming system maintenance or new platform releases.",
      },
      {
        id: "email_on_newsletter",
        label: "Monthly Newsletter",
        description:
          "Receive our monthly roundup of updates, events, and featured research.",
      },
      {
        id: "email_on_marketing",
        label: "Promotions & Offers",
        description:
          "Get information about special offers or events relevant to your interests.",
      },
    ],
  },
];
