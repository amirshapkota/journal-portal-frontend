        ...
        {reviewType === 'SINGLE_BLIND' ? (
          <div className="text-center py-8 border-2 border-dashed rounded-lg">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              Reviewer recommendations are not displayed to maintain the integrity of the blind
              review.
            </p>
          </div>
          ...
          <div className="text-center py-8 border-2 border-dashed rounded-lg">
            <p className="text-sm text-muted-foreground">Failed to load reviewer recommendations</p>
          </div>
        ) : isLoading ? (
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="text-right">
                      <p className="text-sm font-medium text-muted-foreground">Rank #{index + 1}</p>
                    </div>
                  </div>
                </div>
              );
