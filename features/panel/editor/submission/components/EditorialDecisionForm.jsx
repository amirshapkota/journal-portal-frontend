...
export function EditorialDecisionForm({ submissionId, reviews = [], submission = [] }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Decision Form */}
      {!['ACCEPTED', 'COPYEDITING', 'PRODUCTION', 'PUBLISHED', 'REVISED'].includes(
        submission?.status
      ) && (
        <Card>
          <CardHeader>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>Deadline for authors to submit revisions</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
