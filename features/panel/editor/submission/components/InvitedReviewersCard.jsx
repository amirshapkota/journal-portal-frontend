...
export function InvitedReviewersCard({ submission }) {
  if (!submission.review_assignments || submission.review_assignments.length === 0) {
    return null;
  }
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Reviewers who have been invited to review this submission</CardDescription>
      </CardHeader>
      <CardContent>
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 space-y-2">
                  <div className="flex items-center gap-2">
                    <h4 className="font-semibold">{assignment.reviewer_name}</h4>
                    <Badge
                      variant={
                  ...
                  <div className="flex flex-wrap gap-3 mt-2 text-xs text-muted-foreground">
                    ...
                    {assignment.status === 'ACCEPTED' && assignment.days_remaining != null && (
                      <>
                        ...
                        <span
                          className={
                            assignment.days_remaining < 0 ? 'text-destructive font-medium' : ''
                          }
                        >
                  ...
                  {assignment.status === 'DECLINED' && assignment.declined_at && (
                    <div className="text-xs">
                      ...
                      {assignment.decline_reason && (
                        <p className="mt-1 text-destructive">Reason: {assignment.decline_reason}</p>
                      )}
                    </div>
                  )}
