 ...
 */
export function AddProductionParticipantDialog({ isOpen, onClose, assignmentId }) {
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Add an additional participant or collaborator to this production assignment
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <SearchableSelect
              ...
              placeholder={loadingUsers ? 'Loading users...' : 'Select a participant'}
              emptyText={
                usersError
                  ? 'Error loading users'
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={!selectedUserId || addParticipant.isPending}>
