      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="space-y-3">
            <p>
              Complete the journal settings to be able to accept article submissions from authors.
            </p>
            <div className="flex items-start gap-2 rounded-lg border border-blue-200 bg-blue-50 p-3 dark:border-blue-900 dark:bg-blue-950/30">
              ...
              <p className="text-xs text-muted-foreground">
                You can edit journal settings anytime from the journals table dropdown menu by
                selecting &quot;Settings&quot;.
              </p>
            </div>
          </AlertDialogDescription>
        ...
        <AlertDialogFooter>
          <AlertDialogCancel onClick={handleCancel}>Go to Journals</AlertDialogCancel>
          <AlertDialogAction onClick={handleProceedToSettings}>Complete Settings</AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
    </AlertDialog>
  );
