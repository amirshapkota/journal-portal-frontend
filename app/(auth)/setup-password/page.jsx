      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-0 shadow-xl backdrop-blur-sm">
          <CardHeader className="space-y-1 pb-4">
            <CardTitle className="text-2xl text-center">Setup Your Password</CardTitle>
            ...
            {emailSent ? (
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground text-center">
                  Please check your email inbox and follow the instructions to setup your password.
